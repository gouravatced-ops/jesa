...
@section('title', 'Organization List | JESA')
...
<div class="card">
    ...
    <div class="card-head">
        <div>
            ...
            <div class="card-subtitle">Manage template master organizations from the admin panel</div>
        </div>
        <div class="card-actions">
            <form method="GET" action="{{ route('admin.organizations.index') }}" class="search-box" onsubmit="return false;">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function fetchResults() {
            ...
            if (keyword === '') {
                ...
                window.location.href = @json(route('admin.organizations.index'));
                return;
            }

            showSecondaryLoader('Searching organizations...');
            fetch(`${@json(route('admin.organizations.search'))}?search=${encodeURIComponent(keyword)}`, {
                headers: {
